...
@allure.epic("Blog Listing Tests")
@allure.feature("Blog Listing Page")
class TestBlogListing:
  ...
  def test_blog_listing_displays(self, blog_listing_page_loaded):
    """
    ...
    with allure.step("Obtener todos los títulos de los posts"):
      post_titles = blog_listing.get_all_post_titles()
  ...
  def test_user_can_navigate_to_specific_post(
    ...
    with allure.step("Obtener el título del primer post"):
      expected_title = blog_listing.get_all_post_titles()[0]
      allure.attach(
        expected_title,
    ...
    with allure.step("Hacer click en el título del primer post"):
      blog_listing.open_post_by_index(0)
    ...
    with allure.step("Verificar que se abrió el post correcto"):
      actual_title = post_page_scenario.get_post_title()
      allure.attach(
        actual_title,
  ...
  def test_all_posts_have_metadata(self, blog_listing_page_loaded):
    """
